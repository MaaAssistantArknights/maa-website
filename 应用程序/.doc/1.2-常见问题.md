...
- Windows X64用户若在安装以上运行库后运行MAA，弹窗提示 `This application requires one of the following versions of the .NET Farmework: .NET Framework,Version=v4.8.1` ,请安装[.NET Framework 4.8.1](https://dotnet.microsoft.com/zh-cn/download/dotnet-framework/net481)
