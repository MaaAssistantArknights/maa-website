...
export const HomeActions: FC<HomeActionsProps> = ({
  ...
  const docsLinkMapping: Record<string, string> = {
    ...
    'zh-TW': 'https://docs.maa.plus/zh-tw/',
    'en-US': 'https://docs.maa.plus/en-us/',
    'ja-JP': 'https://docs.maa.plus/ja-jp/',
    'ko-KR': 'https://docs.maa.plus/ko-kr/',
  }

  const docsLink = docsLinkMapping[i18n.language] ?? 'https://docs.maa.plus/'
      ...
      >
        <GlowButton translucent href={docsLink} className="docs-highlight">
          <div className="flex items-center -ml-1 text-sm font-medium text-sky-600 dark:text-sky-300">
            <Icon icon={mdiDocument} fontSize="20px" />
        ...
        <GlowButton translucent href="https://discord.gg/23DfZ9uA4V">
          <div className="flex items-center -ml-1 text-sm">
            ...
            <span className="ml-2">{t('references.discord')}</span>
          </div>
        </GlowButton>
        ...
        >
          <div className="flex items-center -ml-1 text-sm">
            ...
            <span className="ml-2">{t('references.friendLinks')}</span>
          </div>
        </GlowButton>
      </div>
      <div
