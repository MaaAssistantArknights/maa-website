...
您可以尝试下载 [NoAVX](https://github.com/MaaAssistantArknights/MaaAssistantArknights/raw/master/3rdparty/ppocr_noavx.zip) 版本的 `PaddleOCR`, 解压后替换本软件中同名的文件。这是对于使用不支持 `AVX` 指令集的 CPU 的用户的性能降低的替代方案，如非必要，请不要使用。  
...
1. 请打开 [下载地址](https://github.com/MaaAssistantArknights/MaaAssistantArknights#下载地址) 中您所需要版本的链接（非镜像站）
2. 找到您所需要下载的文件链接
3. 右键该链接，选择 `复制链接地址`
4. 将链接地址粘贴到浏览器地址栏
