...
我们正在逐步适配雷电模拟器，并且官方也正在进行对应的支持。
最近的更新中修复了一些问题，初步测试已可以正常使用，但我们仍然建议使用时要谨慎，特别是在以下几个方面：

- 只有 **9.0.37** 版本以上的雷电模拟器才能被支持。
- 我们无法保证雷电模拟器可以在所有的电脑上完美运行，但我们正在努力优化适配。
- 如果你在使用雷电模拟器时遇到了问题，请先更新到最新的模拟器版本自行尝试是否可以解决。如果遇到困难，欢迎向我们反馈，我们会尽力提供支持。
