...
**因 json 不支持注释，使用下方示例时需将注释删除**  

[可视化排班生成工具](https://yituliu.site/riicCal/)
    ...
    "plans": [
        {
            ...
            "rooms": {              // 房间信息，必选
                                    ...
                                    // 缺少某个则该设施使用默认算法进行换班。
                                    // 若想不对某个房间换班请使用 skip 字段，或直接在软件 设置 - 基建设置 中取消改设施的勾选
                "control": [
                    {
                        "operators": [
...
[243 极限效率，一天三换](https://github.com/MaaAssistantArknights/MaaAssistantArknights/resource/custom_infrast/243_layout_3_times_a_day.json)  
[153 极限效率，一天三换](https://github.com/MaaAssistantArknights/MaaAssistantArknights/resource/custom_infrast/153_layout_3_times_a_day.json)  
