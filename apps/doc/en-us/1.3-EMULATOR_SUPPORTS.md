...
The recent official update has fixed some issues and provided corresponding support. After a period of testing, we have basically confirmed that it can be used normally.
