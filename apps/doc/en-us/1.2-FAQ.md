...
### Possible cause 2: incompatible CPU instruction set
 ...
 You can also try downloading `PaddleOCR` of [NoAVX](https://github.com/MaaAssistantArknights/MaaAssistantArknights/raw/master/3rdparty/ppocr_noavx.zip) version, unzip and replace the files with the same names. Since it may cause a performance drop, please do not use it unless it is necessary.
...
1. Go to [Download](https://github.com/MaaAssistantArknights/MaaAssistantArknights#Download) to get the link (non-mirror) to you want to download.
