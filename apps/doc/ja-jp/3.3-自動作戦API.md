    ...
    "actions": [                    // 順番に行動, 必須. 順次実行されます
        {
            ...
            "rear_delay": 0,        // 事後遅延 ms（ミリ秒）, オプション, デフォルトは 0
...
[Sample](https://github.com/MaaAssistantArknights/MaaAssistantArknights/resource/copilot/test.json)  
[GA-EX8 Raid](https://github.com/MaaAssistantArknights/MaaAssistantArknights/resource/copilot/GA-EX8-raid.json)
