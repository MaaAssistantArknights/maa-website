...
id: details
title: User Manuel
description: User Manuel for Maa
sidebar_position: 2
---
...
- A tool for creating tasks is provided in the directory of EXE file. See also: [Task schema documenatation](https://github.com/MaaAssistantArknights/MaaAssistantArknights/blob/master/docs/en/TASK_SCHEMA.md) for help.
