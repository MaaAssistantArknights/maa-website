...
本项目为 `tasks.json` 配置了 json schema 检验，schema 文件为 [这个](https://github.com/MaaAssistantArknights/MaaAssistantArknights/blob/master/docs/maa_tasks_schema.json)。
