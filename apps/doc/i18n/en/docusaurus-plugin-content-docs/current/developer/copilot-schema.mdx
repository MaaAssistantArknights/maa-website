---
id: copilot-schema
title: MaaCopilot Schema
description: Schemas for MaaCopilot Combat Flow
sidebar_position: 2
---
...
```jsonc
{
  ...
  "opers": [
    // Operator list
    {
      ...
      "requirements": {
        // Requirements, optional, empty by default
  ...
  "groups": [
    {
      ...
      "opers": [
        // Operators to be chosen randomly, similar to the `opers` field above. Operators with higher levels have higher priority.
        {
          "name": "夜莺", // Nightingale
          "skill": 3,
...
[Sample](https://github.com/MaaAssistantArknights/MaaAssistantArknights/blob/master/docs/resource/copilot/test.json)  
[GA-EX8 Raid](https://github.com/MaaAssistantArknights/MaaAssistantArknights/blob/master/docs/resource/copilot/GA-EX8-raid.json)
